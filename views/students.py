...
async def get_student_info_from_sid(request: Request, sid: Optional[str]=Query(None)):
    ...
    if sid:
        ...
        try:
            ...
            return(templates.TemplateResponse("students/student_info.html", {"request": request}))
...
async def get_current_ee_undergrads(request: Request):
    ...
    return(templates.TemplateResponse("students/current_ee_undergrads.html", undergrad_info))